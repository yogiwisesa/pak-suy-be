...
//@ts-ignore
var knex = knex_1.default(knexfile_1.default[environment]);
function connectDB() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    _a.trys.push([2, 4, , 6]);
                    return [4 /*yield*/, knex.raw('select 1+1 as result')];
                case 3:
                    _a.sent();
                ...
                case 4:
                    error_1 = _a.sent();
                    console.error("Couldn't connect to DB: ", error_1); // eslint-disable-line
                    retries -= 1;
